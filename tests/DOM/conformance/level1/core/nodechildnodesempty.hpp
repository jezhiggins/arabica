#ifndef test_nodechildnodesempty
#define test_nodechildnodesempty
...
class nodechildnodesempty : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodechildnodesempty(std::string name) : baseT(name)
     {
