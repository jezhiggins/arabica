#ifndef test_nodegetownerdocumentnull
#define test_nodegetownerdocumentnull
...
class nodegetownerdocumentnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodegetownerdocumentnull(std::string name) : baseT(name)
     {
