#ifndef test_hc_nodelistindexgetlengthofemptylist
#define test_hc_nodelistindexgetlengthofemptylist
...
class hc_nodelistindexgetlengthofemptylist : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodelistindexgetlengthofemptylist(std::string name) : baseT(name)
     {
