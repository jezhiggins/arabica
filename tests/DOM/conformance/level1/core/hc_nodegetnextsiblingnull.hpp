#ifndef test_hc_nodegetnextsiblingnull
#define test_hc_nodegetnextsiblingnull
...
class hc_nodegetnextsiblingnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodegetnextsiblingnull(std::string name) : baseT(name)
     {
