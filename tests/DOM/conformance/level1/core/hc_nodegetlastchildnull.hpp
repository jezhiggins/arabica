#ifndef test_hc_nodegetlastchildnull
#define test_hc_nodegetlastchildnull
...
class hc_nodegetlastchildnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodegetlastchildnull(std::string name) : baseT(name)
     {
