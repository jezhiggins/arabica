#ifndef test_nodehaschildnodesfalse
#define test_nodehaschildnodesfalse
...
class nodehaschildnodesfalse : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodehaschildnodesfalse(std::string name) : baseT(name)
     {
