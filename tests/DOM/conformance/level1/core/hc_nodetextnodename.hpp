#ifndef test_hc_nodetextnodename
#define test_hc_nodetextnodename
...
class hc_nodetextnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodetextnodename(std::string name) : baseT(name)
     {
