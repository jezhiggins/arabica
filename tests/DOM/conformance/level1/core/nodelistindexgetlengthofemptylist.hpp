#ifndef test_nodelistindexgetlengthofemptylist
#define test_nodelistindexgetlengthofemptylist
...
class nodelistindexgetlengthofemptylist : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodelistindexgetlengthofemptylist(std::string name) : baseT(name)
     {
