#ifndef test_hc_attrfirstchild
#define test_hc_attrfirstchild
...
class hc_attrfirstchild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrfirstchild(std::string name) : baseT(name)
     {
