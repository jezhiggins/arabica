#ifndef test_nodeappendchild
#define test_nodeappendchild
...
class nodeappendchild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeappendchild(std::string name) : baseT(name)
     {
