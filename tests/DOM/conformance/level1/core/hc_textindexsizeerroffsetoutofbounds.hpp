...
#define test_hc_textindexsizeerroffsetoutofbounds
...
class hc_textindexsizeerroffsetoutofbounds : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_textindexsizeerroffsetoutofbounds(std::string name) : baseT(name)
     {
