#ifndef test_nodeinsertbeforenewchilddiffdocument
#define test_nodeinsertbeforenewchilddiffdocument
...
class nodeinsertbeforenewchilddiffdocument : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeinsertbeforenewchilddiffdocument(std::string name) : baseT(name)
     {
