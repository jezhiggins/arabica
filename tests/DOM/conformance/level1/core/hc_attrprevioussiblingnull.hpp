#ifndef test_hc_attrprevioussiblingnull
#define test_hc_attrprevioussiblingnull
...
class hc_attrprevioussiblingnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrprevioussiblingnull(std::string name) : baseT(name)
     {
