#ifndef test_elementsetattributenodenull
#define test_elementsetattributenodenull
...
class elementsetattributenodenull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementsetattributenodenull(std::string name) : baseT(name)
     {
