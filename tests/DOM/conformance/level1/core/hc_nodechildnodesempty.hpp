#ifndef test_hc_nodechildnodesempty
#define test_hc_nodechildnodesempty
...
class hc_nodechildnodesempty : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodechildnodesempty(std::string name) : baseT(name)
     {
