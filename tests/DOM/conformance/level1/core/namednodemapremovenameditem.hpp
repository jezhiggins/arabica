#ifndef test_namednodemapremovenameditem
#define test_namednodemapremovenameditem
...
class namednodemapremovenameditem : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     namednodemapremovenameditem(std::string name) : baseT(name)
     {
