...
class hc_elementgetelementsbytagnamenomatch : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementgetelementsbytagnamenomatch(std::string name) : baseT(name)
     {
