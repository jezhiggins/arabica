#ifndef test_hc_elementremoveattribute
#define test_hc_elementremoveattribute
...
class hc_elementremoveattribute : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementremoveattribute(std::string name) : baseT(name)
     {
