#ifndef test_hc_attrgetvalue1
#define test_hc_attrgetvalue1
...
class hc_attrgetvalue1 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrgetvalue1(std::string name) : baseT(name)
     {
