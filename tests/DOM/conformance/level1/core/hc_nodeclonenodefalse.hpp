#ifndef test_hc_nodeclonenodefalse
#define test_hc_nodeclonenodefalse
...
class hc_nodeclonenodefalse : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeclonenodefalse(std::string name) : baseT(name)
     {
