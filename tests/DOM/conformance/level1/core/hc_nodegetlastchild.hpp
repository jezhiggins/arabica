#ifndef test_hc_nodegetlastchild
#define test_hc_nodegetlastchild
...
class hc_nodegetlastchild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodegetlastchild(std::string name) : baseT(name)
     {
