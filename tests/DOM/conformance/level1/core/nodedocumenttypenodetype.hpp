#ifndef test_nodedocumenttypenodetype
#define test_nodedocumenttypenodetype
...
class nodedocumenttypenodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodedocumenttypenodetype(std::string name) : baseT(name)
     {
