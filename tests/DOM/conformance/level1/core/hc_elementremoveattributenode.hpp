#ifndef test_hc_elementremoveattributenode
#define test_hc_elementremoveattributenode
...
class hc_elementremoveattributenode : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementremoveattributenode(std::string name) : baseT(name)
     {
