#ifndef test_hc_attrsetvalue2
#define test_hc_attrsetvalue2
...
class hc_attrsetvalue2 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrsetvalue2(std::string name) : baseT(name)
     {
