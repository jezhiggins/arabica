#ifndef test_hc_noderemovechildoldchildnonexistent
#define test_hc_noderemovechildoldchildnonexistent
...
class hc_noderemovechildoldchildnonexistent : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_noderemovechildoldchildnonexistent(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      oldChild = doc.createElement(SA::construct_from_utf8("br"));
