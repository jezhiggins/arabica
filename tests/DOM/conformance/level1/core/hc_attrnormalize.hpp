#ifndef test_hc_attrnormalize
#define test_hc_attrnormalize
...
class hc_attrnormalize : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrnormalize(std::string name) : baseT(name)
     {
