#ifndef test_hc_nodevalue07
#define test_hc_nodevalue07
...
class hc_nodevalue07 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodevalue07(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
    ...
    !(("text/html" == baseT::getContentType()))
      ...
      newNode = nodeMap.getNamedItem(SA::construct_from_utf8("alpha"));
