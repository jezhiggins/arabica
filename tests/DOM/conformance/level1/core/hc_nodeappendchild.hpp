#ifndef test_hc_nodeappendchild
#define test_hc_nodeappendchild
...
class hc_nodeappendchild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeappendchild(std::string name) : baseT(name)
     {
