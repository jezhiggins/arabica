#ifndef test_hc_notationssetnameditem1
#define test_hc_notationssetnameditem1
...
class hc_notationssetnameditem1 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_notationssetnameditem1(std::string name) : baseT(name)
     {
