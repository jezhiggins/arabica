#ifndef test_hc_attrlastchild
#define test_hc_attrlastchild
...
class hc_attrlastchild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrlastchild(std::string name) : baseT(name)
     {
