...
#define test_textsplittextnomodificationallowederrEE
...
class textsplittextnomodificationallowederrEE : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     textsplittextnomodificationallowederrEE(std::string name) : baseT(name)
     {
