#ifndef test_hc_nodeattributenodevalue
#define test_hc_nodeattributenodevalue
...
class hc_nodeattributenodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeattributenodevalue(std::string name) : baseT(name)
     {
