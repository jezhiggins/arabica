#ifndef test_nodecommentnodetype
#define test_nodecommentnodetype
...
class nodecommentnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodecommentnodetype(std::string name) : baseT(name)
     {
