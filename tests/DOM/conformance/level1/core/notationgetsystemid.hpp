#ifndef test_notationgetsystemid
#define test_notationgetsystemid
...
class notationgetsystemid : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     notationgetsystemid(std::string name) : baseT(name)
     {
