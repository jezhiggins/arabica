#ifndef test_nodedocumentfragmentnodetype
#define test_nodedocumentfragmentnodetype
...
class nodedocumentfragmentnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodedocumentfragmentnodetype(std::string name) : baseT(name)
     {
