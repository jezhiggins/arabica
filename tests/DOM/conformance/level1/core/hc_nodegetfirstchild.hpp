#ifndef test_hc_nodegetfirstchild
#define test_hc_nodegetfirstchild
...
class hc_nodegetfirstchild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodegetfirstchild(std::string name) : baseT(name)
     {
