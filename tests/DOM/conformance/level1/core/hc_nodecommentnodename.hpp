#ifndef test_hc_nodecommentnodename
#define test_hc_nodecommentnodename
...
class hc_nodecommentnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodecommentnodename(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      for (unsigned int indexN65604 = 0; indexN65604 != elementList.getLength(); indexN65604++) {
          commentNode = (Node) elementList.item(indexN65604);
