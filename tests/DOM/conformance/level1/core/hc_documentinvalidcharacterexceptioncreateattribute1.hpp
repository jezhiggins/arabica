#ifndef test_hc_documentinvalidcharacterexceptioncreateattribute1
#define test_hc_documentinvalidcharacterexceptioncreateattribute1
...
class hc_documentinvalidcharacterexceptioncreateattribute1 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentinvalidcharacterexceptioncreateattribute1(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      
      {
         ...
         try {
            createdAttr = doc.createAttribute(SA::construct_from_utf8(""));
