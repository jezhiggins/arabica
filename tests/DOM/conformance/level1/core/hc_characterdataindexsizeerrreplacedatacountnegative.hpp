...
#define test_hc_characterdataindexsizeerrreplacedatacountnegative
...
class hc_characterdataindexsizeerrreplacedatacountnegative : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataindexsizeerrreplacedatacountnegative(std::string name) : baseT(name)
     {
