#ifndef test_hc_attrgetvalue2
#define test_hc_attrgetvalue2
...
class hc_attrgetvalue2 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrgetvalue2(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
          ...
          
      {
         ...
         try {
            alphaRef = doc.createEntityReference(SA::construct_from_utf8("alpha"));
