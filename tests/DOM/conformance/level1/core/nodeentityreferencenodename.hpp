#ifndef test_nodeentityreferencenodename
#define test_nodeentityreferencenodename
...
class nodeentityreferencenodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeentityreferencenodename(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
    ...
    entRefName = entRefNode.getNodeName();
      baseT::assertEquals("ent2", entRefName, __LINE__, __FILE__);
