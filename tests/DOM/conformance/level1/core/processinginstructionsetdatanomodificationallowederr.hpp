#ifndef test_processinginstructionsetdatanomodificationallowederr
#define test_processinginstructionsetdatanomodificationallowederr
...
class processinginstructionsetdatanomodificationallowederr : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     processinginstructionsetdatanomodificationallowederr(std::string name) : baseT(name)
     {
