#ifndef test_notationgetsystemidnull
#define test_notationgetsystemidnull
...
class notationgetsystemidnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     notationgetsystemidnull(std::string name) : baseT(name)
     {
