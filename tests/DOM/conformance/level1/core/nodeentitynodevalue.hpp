#ifndef test_nodeentitynodevalue
#define test_nodeentitynodevalue
...
class nodeentitynodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeentitynodevalue(std::string name) : baseT(name)
     {
