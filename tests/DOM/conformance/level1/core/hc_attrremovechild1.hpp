#ifndef test_hc_attrremovechild1
#define test_hc_attrremovechild1
...
class hc_attrremovechild1 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrremovechild1(std::string name) : baseT(name)
     {
