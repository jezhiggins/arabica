#ifndef test_hc_characterdatainsertdataend
#define test_hc_characterdatainsertdataend
...
class hc_characterdatainsertdataend : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatainsertdataend(std::string name) : baseT(name)
     {
