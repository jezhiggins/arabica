#ifndef test_hc_nodelistreturnfirstitem
#define test_hc_nodelistreturnfirstitem
...
class hc_nodelistreturnfirstitem : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodelistreturnfirstitem(std::string name) : baseT(name)
     {
