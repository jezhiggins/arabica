#ifndef test_hc_attrappendchild5
#define test_hc_attrappendchild5
...
class hc_attrappendchild5 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrappendchild5(std::string name) : baseT(name)
     {
