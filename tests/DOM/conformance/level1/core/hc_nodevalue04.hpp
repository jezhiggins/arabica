...
class hc_nodevalue04 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodevalue04(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      assertTrue(
    ((baseT::notNull(newNode)) | ("text/html" == baseT::getContentType()))
);
