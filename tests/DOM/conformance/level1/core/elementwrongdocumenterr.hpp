...
#define test_elementwrongdocumenterr
...
class elementwrongdocumenterr : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementwrongdocumenterr(std::string name) : baseT(name)
     {
