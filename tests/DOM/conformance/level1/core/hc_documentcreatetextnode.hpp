#ifndef test_hc_documentcreatetextnode
#define test_hc_documentcreatetextnode
...
class hc_documentcreatetextnode : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentcreatetextnode(std::string name) : baseT(name)
     {
