...
#define test_nodeappendchildnewchilddiffdocument
...
class nodeappendchildnewchilddiffdocument : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeappendchildnewchilddiffdocument(std::string name) : baseT(name)
     {
