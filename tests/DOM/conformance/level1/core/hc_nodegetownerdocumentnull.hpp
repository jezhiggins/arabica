...
#define test_hc_nodegetownerdocumentnull
...
class hc_nodegetownerdocumentnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodegetownerdocumentnull(std::string name) : baseT(name)
     {
