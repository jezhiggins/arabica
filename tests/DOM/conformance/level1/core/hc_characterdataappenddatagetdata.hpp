#ifndef test_hc_characterdataappenddatagetdata
#define test_hc_characterdataappenddatagetdata
...
class hc_characterdataappenddatagetdata : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataappenddatagetdata(std::string name) : baseT(name)
     {
