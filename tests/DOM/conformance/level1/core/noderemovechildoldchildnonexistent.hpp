#ifndef test_noderemovechildoldchildnonexistent
#define test_noderemovechildoldchildnonexistent
...
class noderemovechildoldchildnonexistent : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     noderemovechildoldchildnonexistent(std::string name) : baseT(name)
     {
