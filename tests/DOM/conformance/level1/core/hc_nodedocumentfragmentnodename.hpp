#ifndef test_hc_nodedocumentfragmentnodename
#define test_hc_nodedocumentfragmentnodename
...
class hc_nodedocumentfragmentnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodedocumentfragmentnodename(std::string name) : baseT(name)
     {
