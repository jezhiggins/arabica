#ifndef test_elementreplaceexistingattribute
#define test_elementreplaceexistingattribute
...
class elementreplaceexistingattribute : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementreplaceexistingattribute(std::string name) : baseT(name)
     {
