#ifndef test_elementinvalidcharacterexception
#define test_elementinvalidcharacterexception
...
class elementinvalidcharacterexception : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementinvalidcharacterexception(std::string name) : baseT(name)
     {
