#ifndef test_hc_nodelistindexequalzero
#define test_hc_nodelistindexequalzero
...
class hc_nodelistindexequalzero : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodelistindexequalzero(std::string name) : baseT(name)
     {
