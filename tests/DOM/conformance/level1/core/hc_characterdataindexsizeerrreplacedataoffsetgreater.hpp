#ifndef test_hc_characterdataindexsizeerrreplacedataoffsetgreater
#define test_hc_characterdataindexsizeerrreplacedataoffsetgreater
...
class hc_characterdataindexsizeerrreplacedataoffsetgreater : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataindexsizeerrreplacedataoffsetgreater(std::string name) : baseT(name)
     {
