#ifndef test_nodenotationnodevalue
#define test_nodenotationnodevalue
...
class nodenotationnodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodenotationnodevalue(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      baseT::assertNull(notationValue, __LINE__, __FILE__);
