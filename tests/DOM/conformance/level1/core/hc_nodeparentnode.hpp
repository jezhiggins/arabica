#ifndef test_hc_nodeparentnode
#define test_hc_nodeparentnode
...
class hc_nodeparentnode : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeparentnode(std::string name) : baseT(name)
     {
