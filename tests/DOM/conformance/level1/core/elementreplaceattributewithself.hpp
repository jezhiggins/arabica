#ifndef test_elementreplaceattributewithself
#define test_elementreplaceattributewithself
...
class elementreplaceattributewithself : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementreplaceattributewithself(std::string name) : baseT(name)
     {
