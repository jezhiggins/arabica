#ifndef test_hc_elementnotfounderr
#define test_hc_elementnotfounderr
...
class hc_elementnotfounderr : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementnotfounderr(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      addressElementList = doc.getElementsByTagName(SA::construct_from_utf8("acronym"));
      testAddress = (Element) addressElementList.item(4);
      oldAttribute = doc.createAttribute(SA::construct_from_utf8("title"));
