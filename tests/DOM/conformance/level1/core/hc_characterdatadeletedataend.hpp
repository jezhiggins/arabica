#ifndef test_hc_characterdatadeletedataend
#define test_hc_characterdatadeletedataend
...
class hc_characterdatadeletedataend : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatadeletedataend(std::string name) : baseT(name)
     {
