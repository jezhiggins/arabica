#ifndef test_hc_characterdatagetlength
#define test_hc_characterdatagetlength
...
class hc_characterdatagetlength : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatagetlength(std::string name) : baseT(name)
     {
