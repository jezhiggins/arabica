#ifndef test_elementsetattributenodenomodificationallowederrEE
#define test_elementsetattributenodenomodificationallowederrEE
...
class elementsetattributenodenomodificationallowederrEE : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementsetattributenodenomodificationallowederrEE(std::string name) : baseT(name)
     {
