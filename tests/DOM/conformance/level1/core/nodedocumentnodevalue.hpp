#ifndef test_nodedocumentnodevalue
#define test_nodedocumentnodevalue
...
class nodedocumentnodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodedocumentnodevalue(std::string name) : baseT(name)
     {
