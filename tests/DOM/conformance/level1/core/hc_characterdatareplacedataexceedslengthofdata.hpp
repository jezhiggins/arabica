#ifndef test_hc_characterdatareplacedataexceedslengthofdata
#define test_hc_characterdatareplacedataexceedslengthofdata
...
class hc_characterdatareplacedataexceedslengthofdata : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatareplacedataexceedslengthofdata(std::string name) : baseT(name)
     {
