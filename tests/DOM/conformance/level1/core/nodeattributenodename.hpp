#ifndef test_nodeattributenodename
#define test_nodeattributenodename
...
class nodeattributenodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeattributenodename(std::string name) : baseT(name)
     {
