...
#define test_nodegetprevioussiblingnull
...
class nodegetprevioussiblingnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodegetprevioussiblingnull(std::string name) : baseT(name)
     {
