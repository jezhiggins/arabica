#ifndef test_nodecdatasectionnodevalue
#define test_nodecdatasectionnodevalue
...
class nodecdatasectionnodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodecdatasectionnodevalue(std::string name) : baseT(name)
     {
