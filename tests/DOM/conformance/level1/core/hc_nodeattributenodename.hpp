#ifndef test_hc_nodeattributenodename
#define test_hc_nodeattributenodename
...
class hc_nodeattributenodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeattributenodename(std::string name) : baseT(name)
     {
