#ifndef test_hc_attrhaschildnodes
#define test_hc_attrhaschildnodes
...
class hc_attrhaschildnodes : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrhaschildnodes(std::string name) : baseT(name)
     {
