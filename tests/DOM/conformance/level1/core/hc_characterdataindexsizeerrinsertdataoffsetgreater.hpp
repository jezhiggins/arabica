#ifndef test_hc_characterdataindexsizeerrinsertdataoffsetgreater
#define test_hc_characterdataindexsizeerrinsertdataoffsetgreater
...
class hc_characterdataindexsizeerrinsertdataoffsetgreater : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataindexsizeerrinsertdataoffsetgreater(std::string name) : baseT(name)
     {
