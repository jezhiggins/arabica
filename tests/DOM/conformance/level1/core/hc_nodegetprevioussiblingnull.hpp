#ifndef test_hc_nodegetprevioussiblingnull
#define test_hc_nodegetprevioussiblingnull
...
class hc_nodegetprevioussiblingnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodegetprevioussiblingnull(std::string name) : baseT(name)
     {
