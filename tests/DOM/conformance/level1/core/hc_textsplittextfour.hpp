#ifndef test_hc_textsplittextfour
#define test_hc_textsplittextfour
...
class hc_textsplittextfour : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_textsplittextfour(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      baseT::assertEquals("98551", value, __LINE__, __FILE__);
