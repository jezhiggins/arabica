#ifndef test_hc_noderemovechildgetnodename
#define test_hc_noderemovechildgetnodename
...
class hc_noderemovechildgetnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_noderemovechildgetnodename(std::string name) : baseT(name)
     {
