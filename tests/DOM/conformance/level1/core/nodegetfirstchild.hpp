#ifndef test_nodegetfirstchild
#define test_nodegetfirstchild
...
class nodegetfirstchild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodegetfirstchild(std::string name) : baseT(name)
     {
