#ifndef test_processinginstructiongetdata
#define test_processinginstructiongetdata
...
class processinginstructiongetdata : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     processinginstructiongetdata(std::string name) : baseT(name)
     {
