#ifndef test_hc_characterdatagetdata
#define test_hc_characterdatagetdata
...
class hc_characterdatagetdata : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatagetdata(std::string name) : baseT(name)
     {
