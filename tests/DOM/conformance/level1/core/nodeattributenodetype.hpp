#ifndef test_nodeattributenodetype
#define test_nodeattributenodetype
...
class nodeattributenodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeattributenodetype(std::string name) : baseT(name)
     {
