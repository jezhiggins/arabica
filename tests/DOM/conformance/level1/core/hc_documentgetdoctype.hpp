#ifndef test_hc_documentgetdoctype
#define test_hc_documentgetdoctype
...
class hc_documentgetdoctype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentgetdoctype(std::string name) : baseT(name)
     {
