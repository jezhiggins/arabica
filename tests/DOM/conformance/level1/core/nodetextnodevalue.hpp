#ifndef test_nodetextnodevalue
#define test_nodetextnodevalue
...
class nodetextnodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodetextnodevalue(std::string name) : baseT(name)
     {
