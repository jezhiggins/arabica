#ifndef test_hc_attrinsertbefore1
#define test_hc_attrinsertbefore1
...
class hc_attrinsertbefore1 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrinsertbefore1(std::string name) : baseT(name)
     {
