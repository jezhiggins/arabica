#ifndef test_nodeappendchildinvalidnodetype
#define test_nodeappendchildinvalidnodetype
...
class nodeappendchildinvalidnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeappendchildinvalidnodetype(std::string name) : baseT(name)
     {
