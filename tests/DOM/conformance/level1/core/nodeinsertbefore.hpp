...
class nodeinsertbefore : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeinsertbefore(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      expectedWithWhitespace.push_back(SA::construct_from_utf8("#text"));
      expectedWithWhitespace.push_back(SA::construct_from_utf8("newChild"));
      ...
      expectedWithWhitespace.push_back(SA::construct_from_utf8("#text"));
      expectedWithWhitespace.push_back(SA::construct_from_utf8("address"));
      expectedWithWhitespace.push_back(SA::construct_from_utf8("#text"));
      ...
      expectedWithoutWhitespace.push_back(SA::construct_from_utf8("newChild"));
      ...
      expectedWithoutWhitespace.push_back(SA::construct_from_utf8("address"));
