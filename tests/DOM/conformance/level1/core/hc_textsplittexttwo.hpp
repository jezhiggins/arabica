#ifndef test_hc_textsplittexttwo
#define test_hc_textsplittexttwo
...
class hc_textsplittexttwo : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_textsplittexttwo(std::string name) : baseT(name)
     {
