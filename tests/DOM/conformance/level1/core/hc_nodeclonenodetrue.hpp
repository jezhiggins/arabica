#ifndef test_hc_nodeclonenodetrue
#define test_hc_nodeclonenodetrue
...
class hc_nodeclonenodetrue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeclonenodetrue(std::string name) : baseT(name)
     {
