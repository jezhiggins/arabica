#ifndef test_hc_elementinvalidcharacterexception
#define test_hc_elementinvalidcharacterexception
...
class hc_elementinvalidcharacterexception : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementinvalidcharacterexception(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      
      {
         ...
         try {
            testAddress.setAttribute(SA::construct_from_utf8("invalid^Name"), SA::construct_from_utf8("value"));
