...
#define test_hc_elementgetelementsbytagname
...
class hc_elementgetelementsbytagname : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementgetelementsbytagname(std::string name) : baseT(name)
     {
