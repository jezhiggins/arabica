#ifndef test_elementsetattributenomodificationallowederr
#define test_elementsetattributenomodificationallowederr
...
class elementsetattributenomodificationallowederr : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementsetattributenomodificationallowederr(std::string name) : baseT(name)
     {
