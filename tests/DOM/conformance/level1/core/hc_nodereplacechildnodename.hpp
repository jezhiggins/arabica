#ifndef test_hc_nodereplacechildnodename
#define test_hc_nodereplacechildnodename
...
class hc_nodereplacechildnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodereplacechildnodename(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      childList = ((Element) /*Node */employeeNode).getElementsByTagName(SA::construct_from_utf8("em"));
