#ifndef test_hc_nodevalue06
#define test_hc_nodevalue06
...
class hc_nodevalue06 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodevalue06(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      Document newNode;
      String newValue;
      newNode = (Document) baseT::load("hc_staff", true);
