#ifndef test_nodeentitynodename
#define test_nodeentitynodename
...
class nodeentitynodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeentitynodename(std::string name) : baseT(name)
     {
