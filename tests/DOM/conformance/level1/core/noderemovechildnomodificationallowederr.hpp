#ifndef test_noderemovechildnomodificationallowederr
#define test_noderemovechildnomodificationallowederr
...
class noderemovechildnomodificationallowederr : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     noderemovechildnomodificationallowederr(std::string name) : baseT(name)
     {
