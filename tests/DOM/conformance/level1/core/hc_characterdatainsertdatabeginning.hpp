...
#define test_hc_characterdatainsertdatabeginning
...
class hc_characterdatainsertdatabeginning : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatainsertdatabeginning(std::string name) : baseT(name)
     {
