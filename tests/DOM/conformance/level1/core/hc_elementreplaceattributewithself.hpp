#ifndef test_hc_elementreplaceattributewithself
#define test_hc_elementreplaceattributewithself
...
class hc_elementreplaceattributewithself : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementreplaceattributewithself(std::string name) : baseT(name)
     {
