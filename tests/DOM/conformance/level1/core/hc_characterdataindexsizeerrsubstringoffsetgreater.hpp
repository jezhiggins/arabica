...
#define test_hc_characterdataindexsizeerrsubstringoffsetgreater
...
class hc_characterdataindexsizeerrsubstringoffsetgreater : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataindexsizeerrsubstringoffsetgreater(std::string name) : baseT(name)
     {
