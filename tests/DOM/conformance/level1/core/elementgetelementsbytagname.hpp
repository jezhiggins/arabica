#ifndef test_elementgetelementsbytagname
#define test_elementgetelementsbytagname
...
class elementgetelementsbytagname : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementgetelementsbytagname(std::string name) : baseT(name)
     {
