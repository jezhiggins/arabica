#ifndef test_nodegetprevioussibling
#define test_nodegetprevioussibling
...
class nodegetprevioussibling : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodegetprevioussibling(std::string name) : baseT(name)
     {
