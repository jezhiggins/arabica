#ifndef test_namednodemapremovenameditemreturnnodevalue
#define test_namednodemapremovenameditemreturnnodevalue
...
class namednodemapremovenameditemreturnnodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     namednodemapremovenameditemreturnnodevalue(std::string name) : baseT(name)
     {
