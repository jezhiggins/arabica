...
#define test_hc_characterdataindexsizeerrreplacedataoffsetnegative
...
class hc_characterdataindexsizeerrreplacedataoffsetnegative : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataindexsizeerrreplacedataoffsetnegative(std::string name) : baseT(name)
     {
