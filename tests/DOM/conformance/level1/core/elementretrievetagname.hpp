#ifndef test_elementretrievetagname
#define test_elementretrievetagname
...
class elementretrievetagname : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementretrievetagname(std::string name) : baseT(name)
     {
