#ifndef test_nodeentityreferencenodeattributes
#define test_nodeentityreferencenodeattributes
...
class nodeentityreferencenodeattributes : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeentityreferencenodeattributes(std::string name) : baseT(name)
     {
