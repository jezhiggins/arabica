#ifndef test_nodereplacechildinvalidnodetype
#define test_nodereplacechildinvalidnodetype
...
class nodereplacechildinvalidnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodereplacechildinvalidnodetype(std::string name) : baseT(name)
     {
