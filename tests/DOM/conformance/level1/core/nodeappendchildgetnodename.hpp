#ifndef test_nodeappendchildgetnodename
#define test_nodeappendchildgetnodename
...
class nodeappendchildgetnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeappendchildgetnodename(std::string name) : baseT(name)
     {
