#ifndef test_nodeelementnodename
#define test_nodeelementnodename
...
class nodeelementnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeelementnodename(std::string name) : baseT(name)
     {
