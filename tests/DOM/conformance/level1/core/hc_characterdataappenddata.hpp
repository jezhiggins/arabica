#ifndef test_hc_characterdataappenddata
#define test_hc_characterdataappenddata
...
class hc_characterdataappenddata : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataappenddata(std::string name) : baseT(name)
     {
