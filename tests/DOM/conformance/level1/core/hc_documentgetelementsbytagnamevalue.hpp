...
#define test_hc_documentgetelementsbytagnamevalue
...
class hc_documentgetelementsbytagnamevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentgetelementsbytagnamevalue(std::string name) : baseT(name)
     {
