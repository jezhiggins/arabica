#ifndef test_hc_characterdataindexsizeerrsubstringnegativeoffset
#define test_hc_characterdataindexsizeerrsubstringnegativeoffset
...
class hc_characterdataindexsizeerrsubstringnegativeoffset : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataindexsizeerrsubstringnegativeoffset(std::string name) : baseT(name)
     {
