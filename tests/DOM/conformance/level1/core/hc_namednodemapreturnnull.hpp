#ifndef test_hc_namednodemapreturnnull
#define test_hc_namednodemapreturnnull
...
class hc_namednodemapreturnnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_namednodemapreturnnull(std::string name) : baseT(name)
     {
