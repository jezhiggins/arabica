#ifndef test_notationgetnotationname
#define test_notationgetnotationname
...
class notationgetnotationname : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     notationgetnotationname(std::string name) : baseT(name)
     {
