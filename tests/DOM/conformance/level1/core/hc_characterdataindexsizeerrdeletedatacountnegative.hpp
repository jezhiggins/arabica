#ifndef test_hc_characterdataindexsizeerrdeletedatacountnegative
#define test_hc_characterdataindexsizeerrdeletedatacountnegative
...
class hc_characterdataindexsizeerrdeletedatacountnegative : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdataindexsizeerrdeletedatacountnegative(std::string name) : baseT(name)
     {
