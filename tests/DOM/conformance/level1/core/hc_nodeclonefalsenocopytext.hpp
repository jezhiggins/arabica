#ifndef test_hc_nodeclonefalsenocopytext
#define test_hc_nodeclonefalsenocopytext
...
class hc_nodeclonefalsenocopytext : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeclonefalsenocopytext(std::string name) : baseT(name)
     {
