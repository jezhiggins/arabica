#ifndef test_hc_nodereplacechildnodeancestor
#define test_hc_nodereplacechildnodeancestor
...
class hc_nodereplacechildnodeancestor : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodereplacechildnodeancestor(std::string name) : baseT(name)
     {
