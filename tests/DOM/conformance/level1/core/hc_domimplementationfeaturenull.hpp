#ifndef test_hc_domimplementationfeaturenull
#define test_hc_domimplementationfeaturenull
...
class hc_domimplementationfeaturenull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_domimplementationfeaturenull(std::string name) : baseT(name)
     {
