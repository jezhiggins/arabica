...
class elementreplaceexistingattributegevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementreplaceexistingattributegevalue(std::string name) : baseT(name)
     {
