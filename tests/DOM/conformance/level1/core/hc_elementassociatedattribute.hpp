#ifndef test_hc_elementassociatedattribute
#define test_hc_elementassociatedattribute
...
class hc_elementassociatedattribute : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementassociatedattribute(std::string name) : baseT(name)
     {
