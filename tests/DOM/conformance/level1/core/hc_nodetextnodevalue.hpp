#ifndef test_hc_nodetextnodevalue
#define test_hc_nodetextnodevalue
...
class hc_nodetextnodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodetextnodevalue(std::string name) : baseT(name)
     {
