#ifndef test_nodeclonenodefalse
#define test_nodeclonenodefalse
...
class nodeclonenodefalse : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeclonenodefalse(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      baseT::assertEquals("employee", cloneName, __LINE__, __FILE__);
