#ifndef test_hc_nodevalue05
#define test_hc_nodevalue05
...
class hc_nodevalue05 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodevalue05(std::string name) : baseT(name)
     {
