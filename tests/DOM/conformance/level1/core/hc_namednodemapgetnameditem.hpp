#ifndef test_hc_namednodemapgetnameditem
#define test_hc_namednodemapgetnameditem
...
class hc_namednodemapgetnameditem : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_namednodemapgetnameditem(std::string name) : baseT(name)
     {
