#ifndef test_hc_nodeattributenodetype
#define test_hc_nodeattributenodetype
...
class hc_nodeattributenodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeattributenodetype(std::string name) : baseT(name)
     {
