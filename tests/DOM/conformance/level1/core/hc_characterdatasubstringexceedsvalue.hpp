#ifndef test_hc_characterdatasubstringexceedsvalue
#define test_hc_characterdatasubstringexceedsvalue
...
class hc_characterdatasubstringexceedsvalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatasubstringexceedsvalue(std::string name) : baseT(name)
     {
