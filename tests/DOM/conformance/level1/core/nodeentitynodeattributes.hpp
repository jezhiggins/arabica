#ifndef test_nodeentitynodeattributes
#define test_nodeentitynodeattributes
...
class nodeentitynodeattributes : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeentitynodeattributes(std::string name) : baseT(name)
     {
