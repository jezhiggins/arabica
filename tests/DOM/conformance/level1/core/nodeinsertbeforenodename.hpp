#ifndef test_nodeinsertbeforenodename
#define test_nodeinsertbeforenodename
...
class nodeinsertbeforenodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeinsertbeforenodename(std::string name) : baseT(name)
     {
