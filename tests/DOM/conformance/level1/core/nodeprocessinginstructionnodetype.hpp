#ifndef test_nodeprocessinginstructionnodetype
#define test_nodeprocessinginstructionnodetype
...
class nodeprocessinginstructionnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeprocessinginstructionnodetype(std::string name) : baseT(name)
     {
