#ifndef test_nodereplacechildnodeancestor
#define test_nodereplacechildnodeancestor
...
class nodereplacechildnodeancestor : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodereplacechildnodeancestor(std::string name) : baseT(name)
     {
