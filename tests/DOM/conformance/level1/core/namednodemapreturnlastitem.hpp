#ifndef test_namednodemapreturnlastitem
#define test_namednodemapreturnlastitem
...
class namednodemapreturnlastitem : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     namednodemapreturnlastitem(std::string name) : baseT(name)
     {
