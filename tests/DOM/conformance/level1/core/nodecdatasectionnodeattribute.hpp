#ifndef test_nodecdatasectionnodeattribute
#define test_nodecdatasectionnodeattribute
...
class nodecdatasectionnodeattribute : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodecdatasectionnodeattribute(std::string name) : baseT(name)
     {
