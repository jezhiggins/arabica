#ifndef test_nodeappendchildnomodificationallowederr
#define test_nodeappendchildnomodificationallowederr
...
class nodeappendchildnomodificationallowederr : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeappendchildnomodificationallowederr(std::string name) : baseT(name)
     {
