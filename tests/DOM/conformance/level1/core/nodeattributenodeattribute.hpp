...
#define test_nodeattributenodeattribute
...
class nodeattributenodeattribute : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeattributenodeattribute(std::string name) : baseT(name)
     {
