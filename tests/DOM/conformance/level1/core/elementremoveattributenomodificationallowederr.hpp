#ifndef test_elementremoveattributenomodificationallowederr
#define test_elementremoveattributenomodificationallowederr
...
class elementremoveattributenomodificationallowederr : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementremoveattributenomodificationallowederr(std::string name) : baseT(name)
     {
    ...
    gList = gen.getChildNodes();
     ...
     genElement = (Element) gList.item(0);
      ...
      
      {
         ...
         try {
            genElement.removeAttribute(SA::construct_from_utf8("domestic"));
