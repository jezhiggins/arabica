#ifndef test_hc_characterdatadeletedatabegining
#define test_hc_characterdatadeletedatabegining
...
class hc_characterdatadeletedatabegining : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatadeletedatabegining(std::string name) : baseT(name)
     {
