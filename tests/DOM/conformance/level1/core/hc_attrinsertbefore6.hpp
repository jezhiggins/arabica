...
#define test_hc_attrinsertbefore6
...
class hc_attrinsertbefore6 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrinsertbefore6(std::string name) : baseT(name)
     {
