#ifndef test_hc_namednodemapchildnoderange
#define test_hc_namednodemapchildnoderange
...
class hc_namednodemapchildnoderange : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_namednodemapchildnoderange(std::string name) : baseT(name)
     {
