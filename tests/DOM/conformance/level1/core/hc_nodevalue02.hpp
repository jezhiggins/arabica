#ifndef test_hc_nodevalue02
#define test_hc_nodevalue02
...
class hc_nodevalue02 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodevalue02(std::string name) : baseT(name)
     {
