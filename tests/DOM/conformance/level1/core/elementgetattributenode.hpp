#ifndef test_elementgetattributenode
#define test_elementgetattributenode
...
class elementgetattributenode : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementgetattributenode(std::string name) : baseT(name)
     {
