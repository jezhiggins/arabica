#ifndef test_hc_attrinsertbefore2
#define test_hc_attrinsertbefore2
...
class hc_attrinsertbefore2 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrinsertbefore2(std::string name) : baseT(name)
     {
