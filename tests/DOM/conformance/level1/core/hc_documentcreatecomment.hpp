#ifndef test_hc_documentcreatecomment
#define test_hc_documentcreatecomment
...
class hc_documentcreatecomment : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentcreatecomment(std::string name) : baseT(name)
     {
