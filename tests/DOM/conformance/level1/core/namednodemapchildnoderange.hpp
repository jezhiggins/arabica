...
#define test_namednodemapchildnoderange
...
class namednodemapchildnoderange : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     namednodemapchildnoderange(std::string name) : baseT(name)
     {
