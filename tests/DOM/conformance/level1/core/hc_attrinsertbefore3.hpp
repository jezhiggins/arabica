#ifndef test_hc_attrinsertbefore3
#define test_hc_attrinsertbefore3
...
class hc_attrinsertbefore3 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrinsertbefore3(std::string name) : baseT(name)
     {
