...
#define test_elementgetelementsbytagnameaccessnodelist
...
class elementgetelementsbytagnameaccessnodelist : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementgetelementsbytagnameaccessnodelist(std::string name) : baseT(name)
     {
