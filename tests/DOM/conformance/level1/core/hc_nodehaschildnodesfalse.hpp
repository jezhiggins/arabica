#ifndef test_hc_nodehaschildnodesfalse
#define test_hc_nodehaschildnodesfalse
...
class hc_nodehaschildnodesfalse : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodehaschildnodesfalse(std::string name) : baseT(name)
     {
