#ifndef test_textsplittextfour
#define test_textsplittextfour
...
class textsplittextfour : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     textsplittextfour(std::string name) : baseT(name)
     {
