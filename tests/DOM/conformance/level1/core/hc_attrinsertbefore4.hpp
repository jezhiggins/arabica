#ifndef test_hc_attrinsertbefore4
#define test_hc_attrinsertbefore4
...
class hc_attrinsertbefore4 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrinsertbefore4(std::string name) : baseT(name)
     {
