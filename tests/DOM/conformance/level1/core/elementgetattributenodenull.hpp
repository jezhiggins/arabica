#ifndef test_elementgetattributenodenull
#define test_elementgetattributenodenull
...
class elementgetattributenodenull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementgetattributenodenull(std::string name) : baseT(name)
     {
