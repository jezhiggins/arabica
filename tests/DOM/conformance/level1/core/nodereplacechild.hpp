#ifndef test_nodereplacechild
#define test_nodereplacechild
...
class nodereplacechild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodereplacechild(std::string name) : baseT(name)
     {
