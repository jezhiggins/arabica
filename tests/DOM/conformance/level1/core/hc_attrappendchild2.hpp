#ifndef test_hc_attrappendchild2
#define test_hc_attrappendchild2
...
class hc_attrappendchild2 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrappendchild2(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      newChild = doc.createElement(SA::construct_from_utf8("terday"));
