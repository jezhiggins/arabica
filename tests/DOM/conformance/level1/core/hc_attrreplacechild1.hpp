#ifndef test_hc_attrreplacechild1
#define test_hc_attrreplacechild1
...
class hc_attrreplacechild1 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrreplacechild1(std::string name) : baseT(name)
     {
