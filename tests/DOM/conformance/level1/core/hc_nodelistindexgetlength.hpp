#ifndef test_hc_nodelistindexgetlength
#define test_hc_nodelistindexgetlength
...
class hc_nodelistindexgetlength : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodelistindexgetlength(std::string name) : baseT(name)
     {
