#ifndef test_hc_nodevalue08
#define test_hc_nodevalue08
...
class hc_nodevalue08 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodevalue08(std::string name) : baseT(name)
     {
