#ifndef test_hc_noderemovechild
#define test_hc_noderemovechild
...
class hc_noderemovechild : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_noderemovechild(std::string name) : baseT(name)
     {
