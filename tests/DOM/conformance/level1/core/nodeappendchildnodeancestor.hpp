#ifndef test_nodeappendchildnodeancestor
#define test_nodeappendchildnodeancestor
...
class nodeappendchildnodeancestor : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeappendchildnodeancestor(std::string name) : baseT(name)
     {
