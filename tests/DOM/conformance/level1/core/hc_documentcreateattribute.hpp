#ifndef test_hc_documentcreateattribute
#define test_hc_documentcreateattribute
...
class hc_documentcreateattribute : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentcreateattribute(std::string name) : baseT(name)
     {
