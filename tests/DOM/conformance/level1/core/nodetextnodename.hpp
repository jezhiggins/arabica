#ifndef test_nodetextnodename
#define test_nodetextnodename
...
class nodetextnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodetextnodename(std::string name) : baseT(name)
     {
