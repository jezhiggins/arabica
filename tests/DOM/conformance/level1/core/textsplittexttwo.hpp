#ifndef test_textsplittexttwo
#define test_textsplittexttwo
...
class textsplittexttwo : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     textsplittexttwo(std::string name) : baseT(name)
     {
