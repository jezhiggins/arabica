#ifndef test_nodenotationnodetype
#define test_nodenotationnodetype
...
class nodenotationnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodenotationnodetype(std::string name) : baseT(name)
     {
