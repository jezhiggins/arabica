#ifndef test_hc_attrcreatetextnode
#define test_hc_attrcreatetextnode
...
class hc_attrcreatetextnode : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrcreatetextnode(std::string name) : baseT(name)
     {
