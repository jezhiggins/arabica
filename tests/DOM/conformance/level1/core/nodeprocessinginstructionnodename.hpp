#ifndef test_nodeprocessinginstructionnodename
#define test_nodeprocessinginstructionnodename
...
class nodeprocessinginstructionnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeprocessinginstructionnodename(std::string name) : baseT(name)
     {
