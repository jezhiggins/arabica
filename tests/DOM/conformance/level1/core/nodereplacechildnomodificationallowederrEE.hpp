#ifndef test_nodereplacechildnomodificationallowederrEE
#define test_nodereplacechildnomodificationallowederrEE
...
class nodereplacechildnomodificationallowederrEE : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodereplacechildnomodificationallowederrEE(std::string name) : baseT(name)
     {
