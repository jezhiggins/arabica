#ifndef test_nodedocumentfragmentnodevalue
#define test_nodedocumentfragmentnodevalue
...
class nodedocumentfragmentnodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodedocumentfragmentnodevalue(std::string name) : baseT(name)
     {
