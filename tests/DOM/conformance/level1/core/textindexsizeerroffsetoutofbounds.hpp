...
#define test_textindexsizeerroffsetoutofbounds
...
class textindexsizeerroffsetoutofbounds : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     textindexsizeerroffsetoutofbounds(std::string name) : baseT(name)
     {
