#ifndef test_nodeclonefalsenocopytext
#define test_nodeclonefalsenocopytext
...
class nodeclonefalsenocopytext : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeclonefalsenocopytext(std::string name) : baseT(name)
     {
