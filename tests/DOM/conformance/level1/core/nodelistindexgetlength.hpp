...
#define test_nodelistindexgetlength
...
class nodelistindexgetlength : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodelistindexgetlength(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      assertTrue(
    (baseT::equals(6, length) | baseT::equals(13, length))
);
