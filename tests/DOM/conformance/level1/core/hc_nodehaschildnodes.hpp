#ifndef test_hc_nodehaschildnodes
#define test_hc_nodehaschildnodes
...
class hc_nodehaschildnodes : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodehaschildnodes(std::string name) : baseT(name)
     {
