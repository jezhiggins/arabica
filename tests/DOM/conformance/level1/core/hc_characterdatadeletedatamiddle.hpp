#ifndef test_hc_characterdatadeletedatamiddle
#define test_hc_characterdatadeletedatamiddle
...
class hc_characterdatadeletedatamiddle : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatadeletedatamiddle(std::string name) : baseT(name)
     {
