#ifndef test_hc_attrchildnodes2
#define test_hc_attrchildnodes2
...
class hc_attrchildnodes2 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrchildnodes2(std::string name) : baseT(name)
     {
