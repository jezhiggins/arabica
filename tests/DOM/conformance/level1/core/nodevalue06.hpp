#ifndef test_nodevalue06
#define test_nodevalue06
...
class nodevalue06 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodevalue06(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      Document newNode;
      String newValue;
      newNode = (Document) baseT::load("staff", true);
