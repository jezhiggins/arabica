...
class hc_documentinvalidcharacterexceptioncreateelement1 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentinvalidcharacterexceptioncreateelement1(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      
      {
         ...
         try {
            badElement = doc.createElement(SA::construct_from_utf8(""));
