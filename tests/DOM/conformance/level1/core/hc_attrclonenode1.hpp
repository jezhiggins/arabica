#ifndef test_hc_attrclonenode1
#define test_hc_attrclonenode1
...
class hc_attrclonenode1 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrclonenode1(std::string name) : baseT(name)
     {
