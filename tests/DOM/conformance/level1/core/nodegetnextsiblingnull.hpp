#ifndef test_nodegetnextsiblingnull
#define test_nodegetnextsiblingnull
...
class nodegetnextsiblingnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodegetnextsiblingnull(std::string name) : baseT(name)
     {
