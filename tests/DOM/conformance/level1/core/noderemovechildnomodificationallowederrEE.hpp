...
#define test_noderemovechildnomodificationallowederrEE
...
class noderemovechildnomodificationallowederrEE : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     noderemovechildnomodificationallowederrEE(std::string name) : baseT(name)
     {
