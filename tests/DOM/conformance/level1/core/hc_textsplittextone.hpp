#ifndef test_hc_textsplittextone
#define test_hc_textsplittextone
...
class hc_textsplittextone : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_textsplittextone(std::string name) : baseT(name)
     {
