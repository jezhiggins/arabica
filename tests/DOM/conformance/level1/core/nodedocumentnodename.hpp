#ifndef test_nodedocumentnodename
#define test_nodedocumentnodename
...
class nodedocumentnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodedocumentnodename(std::string name) : baseT(name)
     {
