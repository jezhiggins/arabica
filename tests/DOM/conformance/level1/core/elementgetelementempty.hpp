#ifndef test_elementgetelementempty
#define test_elementgetelementempty
...
class elementgetelementempty : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementgetelementempty(std::string name) : baseT(name)
     {
