#ifndef test_hc_nodeinsertbeforenodeancestor
#define test_hc_nodeinsertbeforenodeancestor
...
class hc_nodeinsertbeforenodeancestor : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeinsertbeforenodeancestor(std::string name) : baseT(name)
     {
