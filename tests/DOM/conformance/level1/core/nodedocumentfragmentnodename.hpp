#ifndef test_nodedocumentfragmentnodename
#define test_nodedocumentfragmentnodename
...
class nodedocumentfragmentnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodedocumentfragmentnodename(std::string name) : baseT(name)
     {
