...
#define test_hc_nodeelementnodetype
...
class hc_nodeelementnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeelementnodetype(std::string name) : baseT(name)
     {
