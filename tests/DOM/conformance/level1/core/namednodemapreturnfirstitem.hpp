#ifndef test_namednodemapreturnfirstitem
#define test_namednodemapreturnfirstitem
...
class namednodemapreturnfirstitem : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     namednodemapreturnfirstitem(std::string name) : baseT(name)
     {
