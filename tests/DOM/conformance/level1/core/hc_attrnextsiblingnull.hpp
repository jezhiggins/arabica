#ifndef test_hc_attrnextsiblingnull
#define test_hc_attrnextsiblingnull
...
class hc_attrnextsiblingnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrnextsiblingnull(std::string name) : baseT(name)
     {
