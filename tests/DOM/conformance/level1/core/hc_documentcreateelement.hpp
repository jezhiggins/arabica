...
#define test_hc_documentcreateelement
...
class hc_documentcreateelement : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentcreateelement(std::string name) : baseT(name)
     {
