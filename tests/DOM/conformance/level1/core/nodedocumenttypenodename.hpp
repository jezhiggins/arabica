#ifndef test_nodedocumenttypenodename
#define test_nodedocumenttypenodename
...
class nodedocumenttypenodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodedocumenttypenodename(std::string name) : baseT(name)
     {
