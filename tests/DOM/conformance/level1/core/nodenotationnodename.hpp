#ifndef test_nodenotationnodename
#define test_nodenotationnodename
...
class nodenotationnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodenotationnodename(std::string name) : baseT(name)
     {
