#ifndef test_nodedocumentnodetype
#define test_nodedocumentnodetype
...
class nodedocumentnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodedocumentnodetype(std::string name) : baseT(name)
     {
