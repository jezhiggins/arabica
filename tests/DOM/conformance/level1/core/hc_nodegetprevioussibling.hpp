#ifndef test_hc_nodegetprevioussibling
#define test_hc_nodegetprevioussibling
...
class hc_nodegetprevioussibling : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodegetprevioussibling(std::string name) : baseT(name)
     {
