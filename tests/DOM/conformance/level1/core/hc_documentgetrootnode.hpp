#ifndef test_hc_documentgetrootnode
#define test_hc_documentgetrootnode
...
class hc_documentgetrootnode : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentgetrootnode(std::string name) : baseT(name)
     {
