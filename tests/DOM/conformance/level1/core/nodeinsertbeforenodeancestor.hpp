#ifndef test_nodeinsertbeforenodeancestor
#define test_nodeinsertbeforenodeancestor
...
class nodeinsertbeforenodeancestor : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeinsertbeforenodeancestor(std::string name) : baseT(name)
     {
