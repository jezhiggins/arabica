#ifndef test_nodereplacechildnodename
#define test_nodereplacechildnodename
...
class nodereplacechildnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodereplacechildnodename(std::string name) : baseT(name)
     {
