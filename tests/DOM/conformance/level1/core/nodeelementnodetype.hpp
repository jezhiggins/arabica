#ifndef test_nodeelementnodetype
#define test_nodeelementnodetype
...
class nodeelementnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeelementnodetype(std::string name) : baseT(name)
     {
