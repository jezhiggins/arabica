#ifndef test_nodeelementnodevalue
#define test_nodeelementnodevalue
...
class nodeelementnodevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeelementnodevalue(std::string name) : baseT(name)
     {
