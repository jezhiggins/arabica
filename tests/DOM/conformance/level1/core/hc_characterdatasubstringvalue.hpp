#ifndef test_hc_characterdatasubstringvalue
#define test_hc_characterdatasubstringvalue
...
class hc_characterdatasubstringvalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatasubstringvalue(std::string name) : baseT(name)
     {
