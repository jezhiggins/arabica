#ifndef test_nodegetlastchildnull
#define test_nodegetlastchildnull
...
class nodegetlastchildnull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodegetlastchildnull(std::string name) : baseT(name)
     {
