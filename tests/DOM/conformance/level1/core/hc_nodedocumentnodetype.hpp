#ifndef test_hc_nodedocumentnodetype
#define test_hc_nodedocumentnodetype
...
class hc_nodedocumentnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodedocumentnodetype(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      baseT::assertEquals(9, nodeType, __LINE__, __FILE__);
