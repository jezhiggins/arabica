#ifndef test_nodehaschildnodes
#define test_nodehaschildnodes
...
class nodehaschildnodes : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodehaschildnodes(std::string name) : baseT(name)
     {
