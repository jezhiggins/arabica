#ifndef test_textsplittextthree
#define test_textsplittextthree
...
class textsplittextthree : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     textsplittextthree(std::string name) : baseT(name)
     {
