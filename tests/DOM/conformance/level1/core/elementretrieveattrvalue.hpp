#ifndef test_elementretrieveattrvalue
#define test_elementretrieveattrvalue
...
class elementretrieveattrvalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementretrieveattrvalue(std::string name) : baseT(name)
     {
