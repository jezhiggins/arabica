...
class textsplittextnomodificationallowederr : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     textsplittextnomodificationallowederr(std::string name) : baseT(name)
     {
