#ifndef test_nodeparentnodenull
#define test_nodeparentnodenull
...
class nodeparentnodenull : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeparentnodenull(std::string name) : baseT(name)
     {
