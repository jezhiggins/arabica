#ifndef test_hc_attrinsertbefore7
#define test_hc_attrinsertbefore7
...
class hc_attrinsertbefore7 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrinsertbefore7(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
          ...
          
      {
         ...
         try {
            dayNode = doc.createCDATASection(SA::construct_from_utf8("day"));
