#ifndef test_hc_characterdatareplacedatabegining
#define test_hc_characterdatareplacedatabegining
...
class hc_characterdatareplacedatabegining : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_characterdatareplacedatabegining(std::string name) : baseT(name)
     {
