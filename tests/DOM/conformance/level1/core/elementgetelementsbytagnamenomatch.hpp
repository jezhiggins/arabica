#ifndef test_elementgetelementsbytagnamenomatch
#define test_elementgetelementsbytagnamenomatch
...
class elementgetelementsbytagnamenomatch : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementgetelementsbytagnamenomatch(std::string name) : baseT(name)
     {
