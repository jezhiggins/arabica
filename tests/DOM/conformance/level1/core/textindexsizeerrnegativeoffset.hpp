#ifndef test_textindexsizeerrnegativeoffset
#define test_textindexsizeerrnegativeoffset
...
class textindexsizeerrnegativeoffset : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     textindexsizeerrnegativeoffset(std::string name) : baseT(name)
     {
