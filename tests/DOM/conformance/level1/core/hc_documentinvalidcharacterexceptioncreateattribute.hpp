#ifndef test_hc_documentinvalidcharacterexceptioncreateattribute
#define test_hc_documentinvalidcharacterexceptioncreateattribute
...
class hc_documentinvalidcharacterexceptioncreateattribute : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_documentinvalidcharacterexceptioncreateattribute(std::string name) : baseT(name)
     {
