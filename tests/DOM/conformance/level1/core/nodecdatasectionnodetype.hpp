#ifndef test_nodecdatasectionnodetype
#define test_nodecdatasectionnodetype
...
class nodecdatasectionnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodecdatasectionnodetype(std::string name) : baseT(name)
     {
