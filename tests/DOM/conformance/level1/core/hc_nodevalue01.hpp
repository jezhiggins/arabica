#ifndef test_hc_nodevalue01
#define test_hc_nodevalue01
...
class hc_nodevalue01 : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodevalue01(std::string name) : baseT(name)
     {
