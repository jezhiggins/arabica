#ifndef test_nodetextnodetype
#define test_nodetextnodetype
...
class nodetextnodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodetextnodetype(std::string name) : baseT(name)
     {
