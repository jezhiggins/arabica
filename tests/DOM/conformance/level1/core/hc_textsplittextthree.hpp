#ifndef test_hc_textsplittextthree
#define test_hc_textsplittextthree
...
class hc_textsplittextthree : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_textsplittextthree(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      baseT::assertEquals(" Jones", value, __LINE__, __FILE__);
