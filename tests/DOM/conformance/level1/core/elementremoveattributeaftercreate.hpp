#ifndef test_elementremoveattributeaftercreate
#define test_elementremoveattributeaftercreate
...
class elementremoveattributeaftercreate : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     elementremoveattributeaftercreate(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      districtAttr = (Attr) attributes.getNamedItem(SA::construct_from_utf8("district"));
