#ifndef test_namednodemapsetnameditemwithnewvalue
#define test_namednodemapsetnameditemwithnewvalue
...
class namednodemapsetnameditemwithnewvalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     namednodemapsetnameditemwithnewvalue(std::string name) : baseT(name)
     {
