#ifndef test_nodeentitynodetype
#define test_nodeentitynodetype
...
class nodeentitynodetype : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     nodeentitynodetype(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      baseT::assertEquals(6, nodeType, __LINE__, __FILE__);
