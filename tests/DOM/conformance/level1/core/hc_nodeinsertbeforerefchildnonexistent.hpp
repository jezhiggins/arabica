#ifndef test_hc_nodeinsertbeforerefchildnonexistent
#define test_hc_nodeinsertbeforerefchildnonexistent
...
class hc_nodeinsertbeforerefchildnonexistent : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodeinsertbeforerefchildnonexistent(std::string name) : baseT(name)
     {
  ...
  typedef bool boolean;
   ...
   void runTest()
   {
      ...
      refChild = doc.createElement(SA::construct_from_utf8("b"));
