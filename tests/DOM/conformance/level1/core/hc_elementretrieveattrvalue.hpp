#ifndef test_hc_elementretrieveattrvalue
#define test_hc_elementretrieveattrvalue
...
class hc_elementretrieveattrvalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_elementretrieveattrvalue(std::string name) : baseT(name)
     {
