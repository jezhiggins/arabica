#ifndef test_hc_attreffectivevalue
#define test_hc_attreffectivevalue
...
class hc_attreffectivevalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attreffectivevalue(std::string name) : baseT(name)
     {
