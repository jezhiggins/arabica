#ifndef test_hc_nodedocumentnodename
#define test_hc_nodedocumentnodename
...
class hc_nodedocumentnodename : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_nodedocumentnodename(std::string name) : baseT(name)
     {
