#ifndef test_hc_attrspecifiedvalue
#define test_hc_attrspecifiedvalue
...
class hc_attrspecifiedvalue : public DOMTestCase<string_type, string_adaptor> 
{
    typedef DOMTestCase<string_type, string_adaptor> baseT;
   public: 
     hc_attrspecifiedvalue(std::string name) : baseT(name)
     {
