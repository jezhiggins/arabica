...
rot13_codecvt::~rot13_codecvt()
{
} // ~rot13_codecvt

std::codecvt_base::result rot13_codecvt::rot13(const char* from,
               const char* from_end,
...
std::codecvt_base::result rot13_codecvt::do_unshift(state_t& state,
                            char* to,
                            char* /* to_limit */,
                            char*& to_next) const
{
...
int rot13_codecvt::do_encoding() const throw()
{
  return 0;
} // do_encoding

bool rot13_codecvt::do_always_noconv() const throw()
{
  return false;
} // do_always_noconv

int rot13_codecvt::do_length(const state_t&,
                        const char* from,
                        const char* end,
                        size_t max) const
{
...
int rot13_codecvt::do_max_length() const throw()
{
  return 1;
} // do_max_length
